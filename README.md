# About
Hi, I am **Shubham Jha** **Artificial Intelligence Professional**, with experience in executing **full life-cycle Data Science projects**; ramping up projects with quality parameters, targeting assignments in **Data Science, Machine Learning and Deep Learning with Features Selection & Feature Engineering techniques**.
- 💻 **Profile Summary:**
    ...
    - 👉 Worked independently for the deployment of Models using Dockers.
...
- 🎓Education: Bachelor's in Electronics & Communication

- 🤹 **Technical Skills:**

    - 🏅 Python, OOPS in Python,
    - 🏅 Machine Learning, Pipeline Creation, Feature Selection, Feature Engineering
    ...
    - 🏅 End-to-End Data Science Projects implementation with Dockerization
    - 🏅 Databases: MongoDB, PHP, MySQL, SQLite
    - 🏅 Platforms: Anaconda, Jupyter Notebook, PyCharm IDE, Visual Studio, Python, Docker, Postman, Windows, Git


- 🤝**Connect Me**
    - https://www.linkedin.com/in/shubhamjha21/
- **Scroll Down, Clone Repository & Start Learning:)**
- **Give ⭐ if it is helpful for you in any way:)**
